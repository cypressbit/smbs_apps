...
@register.inclusion_tag('smbs_social/templatetags/post_to_twitter.html', takes_context=True)
...
@register.inclusion_tag('smbs_social/templatetags/post_to_facebook.html', takes_context=True)
...
@register.inclusion_tag('smbs_social/templatetags/post_to_gplus.html', takes_context=True)
...
@register.inclusion_tag('smbs_social/templatetags/send_email.html', takes_context=True)
...
@register.inclusion_tag('smbs_social/templatetags/post_to_linkedin.html', takes_context=True)
...
@register.inclusion_tag('smbs_social/templatetags/post_to_reddit.html', takes_context=True)
...
@register.inclusion_tag('smbs_social/templatetags/post_to_telegram.html', takes_context=True)
...
def send_whatsapp_url(context, text, obj_or_url=None):
    ...
    url = _build_url(request, obj_or_url)
    text = compile_text(context, text)
    message = _compose_tweet(text, url)
    context['whatsapp_url'] = WHATSAPP_ENDPOINT % urlencode(message)
    return context


@register.inclusion_tag('smbs_social/templatetags/send_whatsapp.html', takes_context=True)
def send_whatsapp(context, title, obj_or_url=None, link_text='Send to Whatsapp'):
    context = send_whatsapp_url(context, title, obj_or_url)
    context['link_text'] = link_text
    return context
