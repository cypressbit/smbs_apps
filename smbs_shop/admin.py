...
from smbs_apps.smbs_shop.models import ShopSettings, Category, Item, ItemReview, Cart, CartItem, Order, OrderItem, Payment
...
class ItemReviewAdmin(admin.ModelAdmin):
    list_display = ['user', 'inventory_item', 'positive_review', 'comment', 'created_at', 'updated_at']
